			...
			for (int i = 0; i < count; i++)
			{
				...
				switch (touch.phase)
				{
					case TouchPhase.Began:
						CallTouchBegan(touch.position, touch.fingerId);
						break;
					case TouchPhase.Moved:
						CallTouchMoved(touch.position, touch.fingerId);
						break;
					case TouchPhase.Ended:
						CallTouchEnded(touch.position, touch.fingerId);
						break;
					case TouchPhase.Canceled:
						CallTouchCanceled(touch.position, touch.fingerId);
						break;
				}
			}
		}
