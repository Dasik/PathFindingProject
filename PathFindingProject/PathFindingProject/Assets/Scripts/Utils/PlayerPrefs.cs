...
namespace DasikUtils
{
    public static class PlayerPrefs
    {
        ...
        private static byte[] bytes = ASCIIEncoding.ASCII.GetBytes("iw3q" + GetUniqueIdentifier().Substring(0, 4));
...
#endif
            Debug.Log("Prefs size: "+ serializedInput.Length);
        ...
        public static void SetString(string key, string value)
        {
            ...
            {
                if (Equals(playerPrefsHashtable[key], value))
                    return;
        ...
        public static void Flush()
        {
            if (hashTableChanged)
            {
                ...
                serializedOutput = "";
                Debug.Log("Flushed: " + playerPrefsHashtable.Count);
            }
        }
